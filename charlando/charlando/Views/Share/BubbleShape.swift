...
struct MesssageBox: View {
    var body: some View {
        Text("123 sdf sdf sdf sdf sd fs df sdf sd fsd f sdf sdf sd fs df sdf sd fsd fsd f sd fs df sd fs df sd fs df sd fs df sd f sd fs df sd f sd fsd f sd fs df  ")
            .padding(.vertical, 8)
...
struct BubbleShapeClone: Shape {
    ...
    func path(in rect: CGRect) -> Path {
        ...
        if !myMessage {
            ...
            bezierPath.addCurve(to: CGPoint(x: width - 20, y: 0), controlPoint1: CGPoint(x: width, y: 8), controlPoint2: CGPoint(x: width - 8, y: 0))
            bezierPath.addLine(to: CGPoint(x: 25, y: 0))
            bezierPath.addCurve(to: CGPoint(x: 5, y: 20), controlPoint1: CGPoint(x: 12, y: 0), controlPoint2: CGPoint(x: 5, y: 8))
            ...
            bezierPath.addCurve(to: CGPoint(x: 0, y: height - 20), controlPoint1: CGPoint(x: 8, y: height), controlPoint2: CGPoint(x: 0, y: height - 8))
            bezierPath.addLine(to: CGPoint(x: 0, y: 20))
            bezierPath.addCurve(to: CGPoint(x: 20, y: 0), controlPoint1: CGPoint(x: 0, y: 8), controlPoint2: CGPoint(x: 8, y: 0))
            bezierPath.addLine(to: CGPoint(x: width - 25, y: 0))
            bezierPath.addCurve(to: CGPoint(x: width - 5, y: 20), controlPoint1: CGPoint(x: width - 12, y: 0), controlPoint2: CGPoint(x: width - 5, y: 8))
